...
| cryptostsem    | The source code of the app's cryptosystem. This file contains the code used to perform cryptographic functions in the application and prove proofs generated by the app. |
| mock election  | The documents related to the mock election conducted using the application.                                                                                              |

# Getting Started

The ethlect. application and keyholders app are packaged and ready to be downloaded and run. This section provides an overview of the steps involved in setting the applications up so you can run them yourself. Feel free to refer to the paper to learn how to navigate the app and what you can do.
